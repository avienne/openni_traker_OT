...
/*topic ou l'on publie si un user est visible/disparait */
ros::Publisher isUserVisible_pub;
ros::Publisher userDisapear_pub;
...
int main(int argc, char **argv) {
	...
	g_UserGenerator.GetSkeletonCap().SetSkeletonProfile(XN_SKEL_PROFILE_NONE);
